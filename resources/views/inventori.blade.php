                ...
                <tbody id="productTable" class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-100 transition duration-300 ease-in-out">
                        ...
                        <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-900 text-center border-r border-gray-300">
                            ...
                            <form id="deleteForm-{{ $p->id }}" action="{{ route('produk.destroy', $p->id) }}" method="POST" class="hidden">
                                @csrf
                                @method('DELETE')
                            </form>
                        </td>
    ...
    <div class="bg-white rounded-lg p-4 w-full max-w-md">
        ...
        <form id="addForm" method="POST" action="{{ route('produk.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="file" id="gambar" name="gambar" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none transition duration-300">
            </div>
...
<div id="editModal" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center hidden" tabindex="-1" aria-hidden="true">
    <div class="bg-white rounded-lg p-4 w-full max-w-md">
        ...
        <form id="editForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label for="edit_nama_produk" class="block text-sm font-medium mb-1">Nama Produk</label>
                <input type="text" id="edit_nama_produk" name="nama_produk" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none transition duration-300" required>
            </div>
            <div class="mb-4">
                <label for="edit_jumlah" class="block text-sm font-medium mb-1">Jumlah</label>
                <input type="number" id="edit_jumlah" name="jumlah" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none transition duration-300" required min="0">
            </div>
            <div class="mb-4">
                <label for="edit_harga" class="block text-sm font-medium mb-1">Harga</label>
                <input type="number" id="edit_harga" name="harga" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none transition duration-300" required min="0.01" step="0.01">
            </div>
            <div class="mb-4">
                <label for="edit_satuan" class="block text-sm font-medium mb-1">Satuan/Berat</label>
                <input type="text" id="edit_satuan" name="satuan" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none transition duration-300" required>
            </div>
            <div class="mb-4">
                <label for="edit_tanggal_kadaluarsa" class="block text-sm font-medium mb-1">Tanggal Kadaluarsa</label>
                <input type="date" id="edit_tanggal_kadaluarsa" name="tanggal_kadaluarsa" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none transition duration-300" required>
            </div>
            <div class="flex justify-end mt-4">
